...
public class EmailUtilController {
	...
	public @ResponseBody
	String queryById(HttpServletRequest request, HttpServletResponse response) {
	...
	public @ResponseBody
	String listDrafts(HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		Map<String, Object> maps = new HashMap<String, Object>();
	...
	public @ResponseBody
	String selectInbox(HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		Map<String, Object> maps = new HashMap<String, Object>();
