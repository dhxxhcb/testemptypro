...
<title><fmt:message code="title.guangdong" /></title>
<style type="text/css">
 *{margin: 0;padding: 0;}
			...
			.content .ban1{ width:100%; height:83%; background: url(img/login/background_4_02_02.jpg) no-repeat;background-size:100% 100%; position: relative;}
</style>
		...
		<div class="content">
			...
			<div class="ban1">
					<div class="entry">
						...
						<p><fmt:message code="title.guangdong" /></p>
						<div class="txt">
