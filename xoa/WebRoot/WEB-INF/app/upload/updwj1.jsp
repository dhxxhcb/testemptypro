...
<form name="userForm1" action="uploadFile?path=D:/测试" enctype="multipart/form-data" method="post">
    <div id="newUpload1">
...
<form name="userForm2" action="uploadFile?path=D:/测试" enctype="multipart/form-data" method="post"">
<div id="newUpload2">
    <input type="file" name="file">
</div>
