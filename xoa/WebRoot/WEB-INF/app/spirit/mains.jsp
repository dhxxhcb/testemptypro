...
<div id="status_bar">
    <table border="0" width="100%" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td class="left">
                <a id="online_link" href="http://192.168.0.23/ispirit/index.php?I_VER=2#"
                   onclick="javascript:ViewOnlineUser();" title="共 20 人，1 人在线">
                    在线<span id="user_count" title="共 20 人，1 人在线">1</span>人 </a>
            </td>
            <td class="center">
