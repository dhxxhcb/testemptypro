	...
	<form action="user/addUser"   method="post" name="form1" id="form1"
		...
		<table class="TableBlock" width="95%" align="center">
			...
			<tr>
				...
				<td nowrap class="TableData"><select name="DEPT_ID"
					class="BigSelect">
						...
						<option value="0" selected>离职人员/外部人员</option>
				</select>&nbsp;&nbsp; <a href="javascript:select_dept_other()">指定其它所属部门</a> <br>如设置为离职人员/外部人员，将对其他用户不可见
				</td>
			</tr>
