...
<div class="bx">
    ...
    <div class="navigation  clearfix">
        <div class="left">
           ...
           <div  class="submit" style="border：1px solid red;border-radius: 4px;  width:60px;height:27px;line-height:27px;background-color:#FF7430;color: #fff;text-align: center;margin-top: 18px;margin-left: 10px;">查询</div>
        </div>
            ...
            <table class="w">
                <thead>
                	<tr>
                    	...
                    	<td class="th"><fmt:message code="news.th.type" /></td>
...
<!-- 	                        <img style="position: absolute;margin-left:9px;cursor: pointer;" src="../img/05.png" alt=""/>
	                    ...
	                    <td class="th"><fmt:message code="news.th.comment" /></td>
	                    <!-- <td class="th">发布部门</td> -->
	                </tr>
                </thead>
                <tbody id="j_tb">                                                                                           
