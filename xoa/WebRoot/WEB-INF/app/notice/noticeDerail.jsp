			 ...
			 $(function () {
				...
				$.ajax({
						...
						success:function(rsp){
							...
							str='<li><div style="display: inline-block; position: relative;top: -4px">发布部门：</div><div class="spanbreak" title="'+data1.depName+'">'+data1.depName+'</div></li><li><span>发布人：</span><span>'+data1.name+'</span></li><li><span>发布时间：</span><span>'+data1.notifyDateTime+'</span></li>';
							$('ul').append(str);
