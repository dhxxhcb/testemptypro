    ...
    <div class="navigation  clearfix">
        <div class="left">
            ...
            <div>
             ...
             <div  class="submit" id="cx"><fmt:message code="global.lang.query" /></div>
        </div>
    ...
    <div class="center" style="width:100%;margin-top: 50px;display: none;">
    	 <div class="login">
	        ...
	        <div class="middle">
	            ...
	            <div class="le ce2">
	                <div class="color" style="width:105px;"><fmt:message code="notice.th.content" />:</div><!-- //内容 -->
	                <div><input id="content"  style="height:25px;width:279px;margin-left:0px;" type="text"/></div>
