...
.ss a{font-size: 14px;display: block;font-family: 微软雅黑;letter-spacing: 1px;position: absolute;left: 26px;top: 1px;color: #fff;}
...
.three a{height: 28px;  line-height: 26px;color:#000;}
...
.boto a.FOUR{background: url("img/file/cabinet11.png") no-repeat;}
...
$(function(){
	$.ajax({
						...
						var files='';
							...
							files+="  <tr><td><input type=\"checkbox\" name=\"\" value=\"\" > <a href=\"${pageContext.request.contextPath }/file/temp\">"+data[i].sortName+ "  </a></td>  <td><img style='width:18px;' src=\"img/file/cabinet@.png\" alt=\"\"/>"+''+ "  </td> <td> "+''+ "  </td><td> "+data[i].sortNo+ "  </td><td><a href='javascript:;'>编辑</a></td></tr>"
							   }else{
							   files+="  <tr><td><input type=\"checkbox\" name=\"\" value=\"\" > <a href=\"${pageContext.request.contextPath }/file/catContent?contentId="+data[i].contentId+"\">"+data[i].subject+ "  </a></td>  <td><img style='width:18px;' src=\"img/file/cabinet@.png\" alt=\"\"/>"+''+ "  </td> <td> "+data[i].sendTime+ "  </td><td> "+data[i].contentId+ "  </td><td><a href='javascript:;'>编辑</a></td></tr>"
							   }
							}
...
<div class="head w clearfix">
    ...
    <div class="ss three"> <a href="${pageContext.request.contextPath }/file/temp">查询</a></div>
