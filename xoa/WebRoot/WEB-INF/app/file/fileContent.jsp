...
function openWindow(sHref,strWidth,strHeight) {
  ...
  <form id="form1" action="">
   &nbsp;&nbsp; <input style="font-size:12px;height=40;width=160" id="BT_Add" type="button" value="+ 新建文件" name="BT_new" 
	onclick="openWindow('${pageContext.request.contextPath }','700','500')"/>&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp; <input style="font-size:12px;height=40;width=160" id="BT_Upload" type="button" value="+ 批量上传" name="BT_new" 
	onclick="openWindow('${pageContext.request.contextPath }','700','500')"/>&nbsp;&nbsp;&nbsp;
