...
<div style="height: 100%">
    ...
    <div  class="cabinet_left">
      ...
      <div onclick="cabinet('2')" id="public"  style="width:50%;height:40px;line-height:40px;  float: left;text-align: left;margin-left: 15px;"><fmt:message code="main.personnel"/></div>
