    ...
    <div id="propertyForm" >
        ...
        <ul class="candidatesUl" style="display: none">
            ...
            <li>
                ...
                <div class="dropDownDiv">
                    <p class="candidatesPTwo">
                        <input type="text" readonly="true" value="不进行自动选择" style="cursor: pointer;"><span><b></b></span>
                        <input type="hidden">
                    </p>
                    <ol class="dropDown">
                        <li>
        ...
        <ul class="candidatesUl">
            ...
            <li>
               ...
               <p class="candidatesPothree">
                ...
                <p class="candidatesPothree">
                    <label>
                        <input type="radio">本步骤经办人
                    </label>
                </p>
                <p class="candidatesPothree">
                    <label>
                        <input type="radio">全部人员
                    </label>
                </p>
            </li>
            <li>
        ...
        <ul class="candidatesUl" style="display: none">
            <li>
                ...
                <p class="candidatesPTwo">
                <input type="text" readonly="true" value="允许选择全部指定的经办人"><span><b></b></span>
                </p>
            </li>
            <li>
                <p class="candidatesPone">
                ...
                <p class="candidatesPTwo" style="margin-bottom: 20px">
                    <input type="text" readonly="true" value="不进行自动选择"><span><b></b></span>
                </p>
            </li>
        </ul>
        <div class="setUpThe">
        ...
        <ul class="candidatesUl" style="display: none">
            <li>
                ...
                <p class="candidatesPothree">
                    <label><input type="radio">明确指定主办人</label>
                </p>
                <p class="candidatesPothree">
                    <label><input type="radio">无主办人会签	</label>
                </p>
                <p class="candidatesPothree">
                    <label><input type="radio">先接收者为主办人	</label>
                </p>
            </li>
            <li>
                <p class="candidatesPone">
            ...
            <li>
                ...
                <p class="candidatesPothree">
                    <label><input type="radio">允许会签</label>
                </p>
                <p class="candidatesPothree">
                    <label><input type="radio">禁止会签	</label>
                </p>
                <p class="candidatesPothree">
                    <label><input type="radio">强制会签	</label>
                </p>
            </li>
            <li>
                <p class="candidatesPone">
                ...
                <p class="candidatesPothree">
                    <label><input type="radio">总是可见</label>
                </p>
                <p class="candidatesPothree">
                    <label><input type="radio">本步骤经办人之间不可见</label>
                </p>
                <p class="candidatesPothree">
                    <label><input type="radio">针对其他步骤不可见</label>
                </p>
            </li>
            <li>
                <p class="candidatesPone">
            ...
            <li>
                ...
                <p class="candidatesPothree">
                    <label><input type="radio">允许退回上一步骤</label>
                </p>
                <p class="candidatesPothree">
                    <label><input type="radio">允许退回之前步骤</label>
                </p>
            </li>
            <li>
                <p class="candidatesPone">
                ...
                <p class="candidatesPothree">
                    <label><input type="radio">禁止并发</label>
                </p>
                <p class="candidatesPothree">
                    <label><input type="radio">允许并发</label>
                </p>
                <p class="candidatesPothree">
                    <label><input type="radio">强制并发</label>
                </p>
            </li>
            <li>
                <p class="candidatesPone">
                ...
                <p class="candidatesPothree">
                    <label><input type="radio">非强制合并</label>
                </p>
                <p class="candidatesPothree">
                    <label><input type="radio">强制合并</label>
                </p>
            </li>
            <li>
                <p class="candidatesPone">
        ...
        <ul class="candidatesUl" style="display: none">
            ...
            <li>
                ...
                <p class="candidatesPothree">
                    <label><input type="radio">本步骤接收后开始计时</label>
                </p>
                <p class="candidatesPothree">
                    <label><input type="radio">上一步骤转交后开始计时</label>
                </p>
            </li>
            <li>
                <p class="candidatesPone">
                ...
                <p class="candidatesPothree">
                    <label><input type="radio">24小时为一天</label>
                </p>
                <p class="candidatesPothree">
                    <label><input type="radio">按个人排班类型工作时长为一天</label>
                </p>
            </li>
            <li>
                <p class="candidatesPone">
