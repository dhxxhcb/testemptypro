							...
							UE.utils
									.loadFile(
											ue.editor.document,
											{
												...
												rel : "stylesheet",
												type : "text/css",
												href : "/static/modules/workflow/system/flow_form/css/form_design.css"
											});
							ue.editor
									.addListener(
			...
			me.commands[thePlugins] = {
				execCommand : function() {
					var dialog = new UE.ui.Dialog(
							{
								iframeUrl : './controls/text/prop_dialog.php?e=ue&FORM_ID=145',
								name : thePlugins,
								editor : this,
								title : '单行输入框',
							...
							var jsDialog = new UE.ui.Dialog(
									{
										...
										// 指定弹出层路径
										iframeUrl : './toolbar/js_css/dialog.php?e=ue&FORM_ID=145&action=SCRIPT',
										// 编辑器实例
										editor : editor,
										// dialog 名称
										name : 'js',
							...
							var cssDialog = new UE.ui.Dialog(
									{
										...
										// 指定弹出层路径
										iframeUrl : './toolbar/js_css/dialog.php?e=ue&FORM_ID=145&action=CSS',
										// 编辑器实例
										editor : editor,
										// dialog 名称
										name : 'css',
