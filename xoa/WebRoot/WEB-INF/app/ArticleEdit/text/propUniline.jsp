...
function BuildCtrlProp()
{
    ...
    var txtFontSizeVal = jQuery.trim(jQuery("#txtFontSize").val()) ? 'font-size:'+jQuery.trim(jQuery("#txtFontSize").val())+'px;' : '';
    ...
    var txtSizeVal = jQuery.trim(jQuery("#txtSize").val()) ? 'width:'+jQuery.trim(jQuery("#txtSize").val())+'px;' : '';
    var txtHeightVal = jQuery.trim(jQuery("#txtHeight").val()) ? 'height:'+jQuery.trim(jQuery("#txtHeight").val())+'px;' : '';
...
function BuildCtrlHTML()
{
    ...
    {
        var txtFontSizeVal = "font-size:"+jQuery.trim(jQuery("#txtFontSize").val())+"px;";
    }
    else
    {
        var txtFontSizeVal = "";
    ...
    {
        var txtSizeVal = "width:"+jQuery.trim(jQuery("#txtSize").val())+"px;";
    }
    else
    {
        var txtSizeVal = "";
    ...
    {
        var txtHeightVal = "height:"+jQuery.trim(jQuery("#txtHeight").val())+"px;";
    }
    else
    {
        var txtHeightVal = "";
			...
			<table cellspacing="3" cellpadding="0" border="0">
                ...
                <tr>
                    ...
                    <td>
						...
						<input id="txtFontSize" type="text" size="10" style="width:80%"/> px
					</td>
				</tr>
				<tr>
					<td>
                    ...
                    <td>
						<%="输入框宽度" %><br />
						<input id="txtSize" type="text" size="10" style="width:80%"/> px
					</td>
				</tr>
				<tr>
					<td>
						<%="输入框宽度" %><br />
						<input id="txtHeight" type="text" size="10" style="width:80%"> px
					</td>
                    <td width="20%">&nbsp;</td>
                    <td><%="数据类型" %><br />
